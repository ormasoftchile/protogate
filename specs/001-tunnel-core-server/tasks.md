...
- [ ] T045 [US2] Create tests/integration/tcp_tunnel_test.cpp - send 1MB data through TCP tunnel, verify byte-for-byte match
...
- [ ] T048 [P] [US2] Create tests/unit/tcp_proxy_test.cpp - test frame parsing, sequence numbers, connection close
